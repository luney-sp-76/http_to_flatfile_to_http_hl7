...
def validate_hl7_message(hl7_message):
    ...
    Returns:
        ...
        and an error message if it is not valid.
    """
...
def generate_ack(hl7_message, ack_type='AA', error_message=None):
    ...
    Args:
        ...
        The error message to include in the ACK
        if the ACK type is not 'AA'. Defaults to None.
    ...
    if len(msh_segment) < 10:
        raise ValueError(
            "Invalid MSH segment: not enough fields to "
...
def send_to_tcp_server(hl7_message, tcp_host='localhost', tcp_port=8082):
    ...
    context.load_cert_chain(
        certfile="./keys/tcp-client-cert.pem",
        keyfile="./keys/tcp-client-key.pem"
    )
    ...
    def do_POST(self):
        ...
        try:
            ...
            if self.path == '/hl7_http':
                ...
                print(
                    f"Forwarded HL7 message to TCP server. Response:"
                    f"{tcp_response}"
                )
                ...
                #  - auto TLS as verify is not set to False
                domain_url = 'https://testresponse.free.beeceptor.com/hl7'
                domain_headers = {'Content-Type': 'text/plain'}
                ...
                print(
                    "Forwarded HL7 message to another domain. "
...
def run_server(
        ...
        handler_class=HL7HTTPRequestHandler,
        port=8080
):
    ...
    Args:
        ...
        handler_class (class, optional):
        The request handler class.
        Defaults to HL7HTTPRequestHandler.
        port (int, optional):
